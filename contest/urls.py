...
urlpatterns = [
    ...
    path('admin/match/management/<int:match_id>/delete_team', views.match_management_delete_team,
         name='match_management_delete_team'),
    path('admin/match/management/<int:match_id>/add_team', views.match_management_add_team,
         name='match_management_add_team'),
    path('admin/match/management/<int:match_id>/update_score/<int:team_id>', views.update_score, name='update_score'),
